...
export const LessonModal = ({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent
        className="max-h-[90vh] w-[96%] overflow-y-auto border border-purple-900/40 bg-[#0a0512] text-purple-100 sm:max-w-[1200px]"
        onInteractOutside={(e) => {
          e.preventDefault();
        }}
      >
          ...
          <div className="flex items-center justify-between">
            <div className="w-full">
              <Link
                ...
                className="mb-6 flex items-center text-sm text-purple-300 transition hover:text-purple-100"
              >
