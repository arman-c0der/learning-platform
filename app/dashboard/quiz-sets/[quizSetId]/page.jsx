...
//                   >
//                     <h2 className="mb-3 bordder border-red-600">{quiz.question}</h2>
...
const EditQuizSet = async ({ params }) => {
  ...
  return (
    <>
      ...
      <div className="p-6">
        <div className="flex items-center justify-end">
          <QuizSetAction quizSetId={quizSet.id} isPublished={quizSet.active} />
        </div>
 
        {/* QuizManager holds the "which quiz is being edited" state,
            and renders BOTH the quiz list and the add/edit form so they stay in sync */}
        <QuizManager quizzes={quizzes} quizSetId={quizSetId} isPublished={quizSet.active}>
          <div className="max-w-[800px]">
